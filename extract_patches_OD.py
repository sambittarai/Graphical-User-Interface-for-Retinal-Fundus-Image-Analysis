...
# =============================Load test data==========================================
def get_data_test_overlap_OD(test_img, patch_height, patch_width, stride_height, stride_width):
    '''
...
def recompone_overlap_OD(preds, img_h, img_w, stride_h, stride_w):
    '''
